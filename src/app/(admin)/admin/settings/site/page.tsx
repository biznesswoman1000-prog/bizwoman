...
// ✅ Fixes:
//  - Correct API endpoint: GET/PUT /settings (not /settings/site)
//  - Logo & favicon use DragDropMediaUploader instead of plain URL inputs
//  - Image spec hints with size/dimension/format guidance
//  - OG image upload
//  - Correct field names matching Prisma schema (logo, favicon, metaImage)
...
function ImageUploadField({
  ...
  folder: string;
  recommended: string;
  maxSizeKB: number; // in kilobytes, for client-side validation
  formats: string;
  tip?: string;
  previewClass?: string;
}) {
...
export default function AdminSiteSettingsPage() {
  ...
  useEffect(() => {
    // ✅ Correct endpoint: GET /settings (not /settings/site)
    apiGet<any>("/settings")
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      // ✅ Correct endpoint: PUT /settings (not /settings/site)
    ...
    <div className="p-6 max-w-2xl space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-5">
          ...
          <ImageUploadField
            label="Logo"
            value={settings.logo || ""} // ✅ schema field: logo
          ...
          <ImageUploadField
            label="Favicon"
            value={settings.favicon || ""} // ✅ schema field: favicon
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4">
          ...
          <ImageUploadField
            ...
            value={settings.metaImage || ""} // ✅ schema field: metaImage
